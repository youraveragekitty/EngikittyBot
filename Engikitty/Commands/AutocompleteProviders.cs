...
namespace Engikitty.Commands
{
    ...
    public class KokoroVoiceAutocompleteProvider : IAutocompleteProvider<AutocompleteInteractionContext>
    {
        public ValueTask<IEnumerable<ApplicationCommandOptionChoiceProperties>?> GetChoicesAsync(
            ApplicationCommandInteractionDataOption Option, 
            AutocompleteInteractionContext Context)
        {
            ...
            IEnumerable<ApplicationCommandOptionChoiceProperties> Choices = CmdStorage.KokoroVoices
                .Where(Pair =>
                    Query.Length == 0 ||
